...
<body>
    ...
    <header class="header">
        ...
        <div class="profile">
            ...
            <img src="<?= htmlspecialchars('/assets/images/apprenant/default.png') ?>" alt="Photo Profil" class="profile-img">
            </div>
    </header>
        ...
        <div class="cards-container">
            ...
            <div class="card">
                <div class="profile-card">
                    <img src="<?= htmlspecialchars('/assets/images/apprenant/default.png') ?>" class="profile-big-img">
