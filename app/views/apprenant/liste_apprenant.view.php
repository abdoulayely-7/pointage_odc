    ...
    >
      ...
      <select name="classe">
          ...
          <?php foreach ($referenciels as $ref): ?>
              <option value="<?= $ref['id'] ?>" <?= (isset($_GET['classe']) && $_GET['classe'] == $ref['id']) ? 'selected' : '' ?>>
    ...
    <tr>
      <td>
        <?php if (!empty($apprenant['photo'])): ?>
          <img src="<?= htmlspecialchars('/assets/images/apprenant/default.png') ?>" alt="Photo" class="photo">
        <?php else: ?>
          <img src="/assets/images/apprenant/default.png" alt="Photo par défaut" class="photo">
        <?php endif; ?>
      </td>
